...
<body>
    <form class="login" action="signIn.php" method="post">
         <legend>Enregistrer une vaccination</legend>
        </br>
        Date de la vaccination :
        <input type="date" placeholder="Date de vaccination" name="dateV">
        <input type="text" placeholder="Produit utilisé" name="produit">
        Date de rappel de vaccination :
        <input type="date" placeholder="Date de rappel" name="dateRV">
        <div class="btn-toolbar">
        <button type="button" id="btnEnregistrer" class="btn btn-primary btn-sm">Enregistrer</button>
        ...
        <button type="button" id="btnAnnuler" class="btn btn-primary btn-sm">Annuler</button>
        </div>
    </form>
